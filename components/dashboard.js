...
import {
  ...
  LocalLaundryService as ClothIcon,
  Inventory as DetergentIcon,
...
const DashboardLayout = ({ children }) => {
  ...
  const drawerItems = [
    ...
    { text: "Transaction", icon: <TransactionIcon />, link: "/transac" },
    { text: "Type of Cloth", icon: <ClothIcon />, link: "/cloths" },
    { text: "Type of Detergent", icon: <DetergentIcon />, link: "/detergent" },
      ...
      >
        ...
        <List>
          {drawerItems.map((item, index) => (
            ...
            >
              <ListItemIcon sx={{ color: pathname === item.link ? 'white' : 'inherit' }}>
                {item.icon}
              </ListItemIcon>
              <ListItemText 
                primary={item.text} 
